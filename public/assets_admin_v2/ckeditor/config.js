...
CKEDITOR.editorConfig = function( config ) {
	config.toolbarGroups = [
		...
		{ name: 'paragraph', groups: [ 'list', 'indent', 'blocks', 'align', 'JustifyLeft', 'JustifyRight', 'JustifyCenter', 'JustifyBlock', 'bidi', 'paragraph' ] },
	...
	config.extraPlugins = 'justify,colorbutton,panelbutton,floatpanel';
