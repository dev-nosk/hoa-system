...
--
-- Table structure for table `form_tab`
--
...
--
-- Dumping data for table `form_tab`
--

LOCK TABLES `form_tab` WRITE;
/*!40000 ALTER TABLE `form_tab` DISABLE KEYS */;
INSERT INTO `form_tab` VALUES (1,'General Info','information',1,1,NULL,NULL),(2,'Service Info','service ',1,1,NULL,NULL);
