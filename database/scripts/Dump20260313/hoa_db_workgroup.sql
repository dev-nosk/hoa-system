...
CREATE TABLE `workgroup` (
  ...
  `workgroup_name` text COLLATE utf8mb4_unicode_ci,
  `description` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `create` int NOT NULL DEFAULT '0',
  `list_view` int NOT NULL DEFAULT '0',
  `upload` int NOT NULL DEFAULT '0',
  `attachement_create` int NOT NULL DEFAULT '0',
  `attachement_view` int NOT NULL DEFAULT '0',
  `attachement_delete` int NOT NULL DEFAULT '0',
...
INSERT INTO `workgroup` VALUES (1,'Admin','for admin only',1,1,1,1,1,1,1,NULL,NULL,NULL,0);
...
-- Dump completed on 2026-03-13 13:04:41
