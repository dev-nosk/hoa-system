...
$form_workgroup =   session('form_workgroup');
$home           =  session('home');
$forms          =  session('forms');
?>
                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item"><!-- label-->
                                ...
                                <a class="nav-link dropdown-indicator" href="#toggle-{{ $form['id']}}" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="toggle-{{ $form['id']}}">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span class="fa {{ $form['icon'] }}"></span></span><span class="nav-link-text ps-1">{{ $form['form_name'] }} </span>
                                    </div>
                                </a>
